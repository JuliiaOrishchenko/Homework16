...
class ProductStore:
    ...
    def add(self, product, amount):
        try:
            ...
            raise ValueError("Can`t add this product")
    ...
    def set_discount(self, identifier, percent, identifier_type="name"):
        if any(identifier in item.values() for item in self.products.values()):
            ...
            raise ValueError("Can`t set the discount")
        return self.products
    ...
    def set_discount_by_name(self, identifier, percent):
        if self.products.get(identifier):
            ...
            raise ValueError('Can`t set this discount')
        return self.products
...
shop1 = ProductStore()
orange = Products("fruits", "orange", 20)
apple = Products("fruits", "apple", 10)
print(shop1.add(orange, 5))
print(shop1.add(apple, 20))
print(shop1.set_discount("orange", 20))
print(shop1.sell_product("orange", 2))
print(shop1.get_income())
print(shop1.get_all_products())
print(shop1.get_product_info("orange"))
